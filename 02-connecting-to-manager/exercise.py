...
You are going to write the handshake by hand, with plain `requests` and plain
functions.
"""
...
# TASK 1 — Authenticate
#
# The Manager (before v20.18) does not use bearer tokens. There are two steps:
#
...
#
#    THE TRAP: a wrong password does NOT return 401. It returns HTTP 200 with
