"""Module 6 — annotated solution for the validated change pipeline."""
...
# the module 5 deliberate error (TODO 2.1), which is the student's to fix —
# their own pipeline.py applies ../05-terraform once they have.
TERRAFORM_DIR = Path(__file__).resolve().parents[2] / "05-terraform" / "solution"
