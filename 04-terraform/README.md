# Module 4 — Terraform, properly (45 min + extensions)

The same change as module 3, now declarative — and then two things the
module 3 script never had: credentials it fetches itself, and state someone
...
The only secret left in your shell is `VAULT_TOKEN`.
...
The third column is the only one you can hand to a pipeline, and module 5 is
that pipeline.
